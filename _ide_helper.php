 ...
 * Generated for Laravel 6.6.2 on 2019-12-07 10:53:43.
 *
...
namespace Envant\Fireable\Facades { 
    ...
    class Fireable {
         ...
         *
         * @param \Envant\Fireable\FireableAttributes|\Envant\Fireable\Model $model
         * @return void 
         * @static 
         */ 
        public static function processAttributes($model)
        {
                        /** @var \Envant\Fireable\Fireable $instance */
                        $instance->processAttributes($model);
        }
...
namespace Pbmedia\LaravelFFMpeg { 
    ...
    class FFMpegFacade {
        ...
        {
                        /** @var \Pbmedia\LaravelFFMpeg\FFMpeg $instance */
        ...
        {
                        /** @var \Pbmedia\LaravelFFMpeg\FFMpeg $instance */
                        return $instance->fromDisk($diskName);
        }
...
namespace Webklex\IMAP\Facades { 
    ...
    class Client {
        ...
        {
                        /** @var \Webklex\IMAP\ClientManager $instance */
...
namespace  { 
    ...
    class Fireable extends \Envant\Fireable\Facades\Fireable {}
