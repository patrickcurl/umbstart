...
if (! function_exists('mimetypes')) {
    ...
    function mimetypes()
    {
        return json_decode(file_get_contents(app_dir('Core/Support/data/mimetypes.json')), true);
    }
}
...
if (! function_exists('timezones')) {
    ...
    function timezones()
    {
        return json_decode(file_get_contents(app_dir('Core/Support/data/data/timezones.json')), true);
    }
}
