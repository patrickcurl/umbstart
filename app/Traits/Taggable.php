...
trait Taggable
{
    ...
    {
        return $this->morphToMany('tags', 'taggable', 'taggables', 'taggable_id', 'tag_id')
                    ->orderBy('weight')
                    ->withTimestamps();
    }
     ...
     */
    public function scopeWithAllTags(Builder $builder, $tags, string $group = null): Builder
    {
        $tags = $this->parseTags($tags, $group);
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeWithAnyTags(Builder $builder, $tags, string $group = null): Builder
    {
        $tags = $this->parseTags($tags, $group);
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeWithoutTags(Builder $builder, $tags, string $group = null): Builder
    {
        $tags = $this->parseTags($tags, $group);
     ...
     * @return bool
     */
    public function hasAnyTags($tags, string $group = null): bool
    {
        $tags = $this->parseTags($tags, $group);
     ...
     * @return bool
     */
    public function hasAllTags($tags, string $group = null): bool
    {
        $tags = $this->parseTags($tags, $group);
     ...
     * @return array
     */
    protected function parseTags($rawTags, string $group = null, $create = false): array
    {
        ...
        return $tags->merge(app('tags.tag')->{$create ? 'findByNameOrCreate' : 'findByName'}($strings->toArray(), $group)->pluck('id'))->toArray();
    }
}
