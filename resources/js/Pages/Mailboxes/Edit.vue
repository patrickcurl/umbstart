  ...
  <div>
    ...
    <div class="mt-6 bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="contact in team.contacts" :key="contact.id" class="hover:bg-grey-lightest focus-within:bg-grey-lightest">
          <td class="border-t">
        ...
        <tr v-if="team.contacts.length === 0">
  ...
  data () {
    return {
      ...
      form: {
        ...
        postal_code: this.team.postal_code
      }
    }
  },
  methods: {
