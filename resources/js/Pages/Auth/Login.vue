<template>
  <div class="p-6 bg-indigo-darker min-h-screen flex justify-center items-center">
    <div class="w-full max-w-sm">
      <umbric-logo-png class="block mx-auto w-full max-w-xs fill-white" height="50" />
      <form class="mt-8 bg-white rounded-lg shadow-lg overflow-hidden" @submit.prevent="submit">
        <div class="px-10 py-12">
          ...
          <text-input id="passwordInput" v-model="form.password" class="mt-6" label="Password" type="password" />
        ...
        <div class="px-10 py-4 bg-grey-lightest border-t border-grey-lighter flex justify-between items-center">
          ...
          <!--  <inertia-link href="/register" role="button" class="btn-orange">
            Register
          </inertia-link> -->
        </div>
      </form>
...
<script>
import { UmbricLogoPng, LoadingButton, TextInput } from '@/Shared'
